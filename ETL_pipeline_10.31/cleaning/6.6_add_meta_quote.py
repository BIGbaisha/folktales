# -*- coding: utf-8 -*-
# Created: 2025/10/31
# yuzhongqu_special\6.6_add_meta_quote.py
"""
==============================================================
民族 / 地点 信息提取统一版（融合脚本）
--------------------------------------------------------------
...
INPUT_PATH  = Path(r"I:\中国民间传统故事\分卷清洗\yuzhongqu\6.5_Chinese Folk Tales_yuzhongqu.md")
OUTPUT_PATH = Path(r"I:\中国民间传统故事\分卷清洗\yuzhongqu\6.6_Chinese Folk Tales_yuzhongqu.md")
CSV_PATH    = Path(r"I:\中国民间传统故事\分卷清洗\yuzhongqu\6.6_meta_extraction_summary.csv")
