...
INPUT_PATH  = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.5_Chinese Folk Tales_sichuan.md")
OUTPUT_PATH = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.6_Chinese Folk Tales_sichuan.md")
CSV_PATH    = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.6_meta_extraction_summary.csv")
