...
OUTPUT_PATH = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.4_Chinese Folk Tales_sichuan.md")
CSV_PATH = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.4_detected_single_digits.csv")
