...
# 配置区
# ==========================================================
INPUT_PATH  = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.8_Chinese Folk Tales_sichuan.md")
OUTPUT_PATH = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.8_Chinese Folk Tales_sichuan.md")
CSV_PATH    = Path(r"I:\中国民间传统故事\分卷清洗\sichuan\6.5_detected_blocks.csv")

ONLY_DETECT = True  # True = 仅检测; False = 执行删除

# ✅ 自定义触发关键字，可扩展
TRIGGER_KEYWORDS = [
    "讲述者","口述者","采录者","翻译者","译述者","整理者","记录者","来录者",
    "叙述者","叙事者","传述者","提供者","采访者","回忆记录者","讲还者","讲述记录者",
    "讲述、记录者","评述者","讲述采录者","采集时间","注","流传时间"
]
# ==========================================================
# 正则定义
# ==========================================================
