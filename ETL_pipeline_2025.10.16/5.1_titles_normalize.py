...
2. 若行首带单个 # 但不在 H1 规则中（前言、后记、神话、传说、故事），
   且未被识别为 H1~H4 标题 → 去掉 # 并加粗 **...**，output to 5_guizhou_emphasized_h1.csv
...
# 路径配置
# ==========================================================
INPUT_PATH    = r"I:\中国民间传统故事\分卷清洗\yuzhongqu\Chinese Folk Tales_yuzhongqu.md"
OUTPUT_TARGET = r"I:\中国民间传统故事\分卷清洗\yuzhongqu\5.1_Chinese Folk Tales_yuzhongqu.md"
CSV_PATH      = r"I:\中国民间传统故事\分卷清洗\yuzhongqu\5.1_yuzhongqu_heading_stats.csv"
CSV_EMPH_PATH = r"I:\中国民间传统故事\分卷清洗\yuzhongqu\5.1_yuzhongqu_emphasized_h1.csv"
